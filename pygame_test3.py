...
class Tiles:
    def __init__(self, left, top, width, height, kda_tile):
        ...
        Tiles.img_src = pygame.image.load(
            f"./my_env/pygame_project/zombie_project/zombiegame/png/Tiles/Tile ({self.kda_tile}).png"
        ).convert_alpha()
...
class Blocks:
    def __init__(self, left, top, width, height, kda_block):
        ...
        Blocks.img_src = pygame.image.load(
            f"./my_env/pygame_project/zombie_project/zombiegame/png/Tiles/Tile ({self.kda_block}).png"
        ).convert_alpha()
...
class Tombs:
    def __init__(self, left, top, kda_tomb):
        ...
        Tombs.img_src = pygame.image.load(
            f"./my_env/pygame_project/zombie_project/zombiegame/png/Objects/TombStone ({self.kda_tomb}).png"
        ).convert_alpha()
...
pygame.display.set_caption("Test03")
...
# 배경
background = pygame.image.load("./my_env/pygame_project/zombie_project/zombiegame/png/BG.png").convert()
...
zombie_sprites_rev = []
for i in range(1, 10):
    img = pygame.image.load(f"./my_env/pygame_project/zombie_project/zombiegame/png/male/Walk ({i}).png").convert_alpha()
    w, h = img.get_size()
